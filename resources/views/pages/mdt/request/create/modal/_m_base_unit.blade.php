<div class="modal fade bd-example-modal-lg baseUnitModal shadow" style="z-index: 1041" tabindex="-1" id="baseUnitModal"
    role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="datatable datatable-primary"><br>
                    ...
                    <table id="lookUpBaseUnit" class="table table-striped table-bordered table-hover" width="100%">
                        <thead>
