<div class="modal fade bd-example-modal-lg divisionModal shadow" style="z-index: 1041" tabindex="-1" id="divisionModal"
    role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="datatable datatable-primary"><br>
                    ...
                    <table id="lookUpDivision" class="table table-striped table-bordered table-hover" width="100%">
                        <thead>
                            {{-- style="background-color: #D3D3D3" --}}
                            <tr role="row">
                                <th tabindex="0" rowspan="1" colspan="1" style="width: 403px;">Division
                                </th>
