...
@section('sub-title', 'Raw Material Transfer Posting')
@section('breadcrumb')
    <li class="nav-home">
        <a href="#">
...
@section('content')
    ...
    <form id="form" method="post">
        ...
        <audio id="Audiosucces" src="{{ url('backend\audio\succes.mp3') }}"></audio>
        <audio id="Audioerror" src="{{ url('backend\audio\error.mp3') }}"></audio>
    ...
    @include('pages.wtf.wh_transfer.raw_mat.ajax_rm')
@endsection('content')
